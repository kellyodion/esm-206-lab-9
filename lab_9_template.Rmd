...
#Note: Don't do this because price pr square foot is calculated from the dependent variable price -- (biased overfitting of model results) 
...
class(homes_sub$City) #check what class it is currently 
...
# Overall, heteroscedasticity is OK, residuals normaility looks good, and conceptually and mathematically the model is making sense! 
```
...
#I would still pick homes_lm3 because: # Overall, heteroscedasticity is OK, residuals normaility looks good, and conceptually and mathematically the model is making sense!
```
